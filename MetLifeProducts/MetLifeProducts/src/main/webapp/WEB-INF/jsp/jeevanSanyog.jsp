...
<body>
	...
	<h3 style="color: SteelBlue;">
		<div style='text-align: center'>Key Benefits of Jeevan Sanyog Premium
			Back Cover</div>
	</h3>
	...
	PNB MetLife Jeevan Sanyog Premium Back Cover is a health insurance plan that
	...
	<table>
		<tr>
			<th><h3 align="center">Jeevan Sanyog Premium Covers</h3></th>
			<th></th>
		...
		<tr>
			...
			<td rowspan="3">
				<table align="center" class="table1">
					...
					<tr>
						<td rowspan="2">35-year-old Mr Arvind bought MetLife Jeevan Sanyog
		...
		<tr>
			<td style="margin-top: 20"><div style="text-align: center;">
					<a href="premiumJeevanSanyog">Premium Info </a><br> <br>
				</div></td>
			<td></td>
		</tr>
	</table>
